...
app.post('/', function (req, res) {
    req.query.serverPath !== undefined ? contentRootPath = contentRootPath + req.query.serverPath : contentRootPath = contentRootPath;
    console.log(path)
    replaceRequestParams(req, res);
    req.setTimeout(0);
    function getRules() {
    ...
    if (req.body.action == "read") {
        // fetech the query parameter
        const serverPath = req.query.serverPath;
        console.log("server root: ", serverPath);
        console.log("content root path: ", contentRootPath);
        (async () => {
